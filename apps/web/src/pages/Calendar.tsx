...
import { useCalendarEvents, type CalendarEvent } from "@/hooks/useSupabaseData";
  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Idea Timeline</h1>
          <p className="text-sm text-muted mt-1">Track when ideas were discovered.</p>
        </div>
